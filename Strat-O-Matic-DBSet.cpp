...
// Strat-O-Matic-DBSet.cpp : implementation of the CStratOMaticDBSet class
//
...
// CStratOMaticDBSet implementation

// code generated on Sunday, March 09, 2014, 11:13 AM

IMPLEMENT_DYNAMIC(CStratOMaticDBSet, CRecordset)

CStratOMaticDBSet::CStratOMaticDBSet(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_BatterID = 0;
	m_FirstName = L"";
...
CString CStratOMaticDBSet::GetDefaultConnect()
{
...
CString CStratOMaticDBSet::GetDefaultSQL()
{
	return _T("[Batter]");
}

void CStratOMaticDBSet::DoFieldExchange(CFieldExchange* pFX)
{
...
/////////////////////////////////////////////////////////////////////////////
// CStratOMaticDBSet diagnostics

#ifdef _DEBUG
void CStratOMaticDBSet::AssertValid() const
{
	CRecordset::AssertValid();
}

void CStratOMaticDBSet::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
