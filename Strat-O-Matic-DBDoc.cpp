...
void CStratOMaticDBDoc::ExportBaseFileToDB(CString strDir, CString strTeamName)
{
	SYSTEMTIME lt;
	CString SqlString;
	CString lLastName;
...
void CStratOMaticDBDoc::ExportLeagueFileToDB(CString strDir, CString strTeamName)
{
	SYSTEMTIME lt;
	CString SqlString;
	CString lLastName;
