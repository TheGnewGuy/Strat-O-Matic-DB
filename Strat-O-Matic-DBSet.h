...
// Strat-O-Matic-DBSet.h: interface of the CStratOMaticDBSet class
//
...
class CStratOMaticDBSet : public CRecordset
{
public:
	CStratOMaticDBSet(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CStratOMaticDBSet)
